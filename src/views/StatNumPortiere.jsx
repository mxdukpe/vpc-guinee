      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 ml-64 mt-16 p-6 font-sans overflow-y-auto">
          <div className="bg-white shadow rounded-xl p-8">
            <h2 className="text-center text-2xl font-semibold text-gray-800 mb-6">Statistiques des numéros de portière</h2>
            ...
            <div className="bg-gray-100 p-4 rounded-md mb-6">
              <h2 className="text-center text-xl font-medium mb-4">Statistiques des numéros de portière</h2>
...
export default StatNumPortiere;
